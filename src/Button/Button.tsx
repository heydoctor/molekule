...
// have to use & ...Props and FC<...> because typing is missing, dont know why
const ButtonForward: FC<React.ComponentProps<typeof StyledButton> & ButtonProps> = React.forwardRef(
...
Button.Group = createComponent<ButtonGroupProps>({
  name: 'ButtonGroup',
  as: Flex,
